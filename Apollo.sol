...
contract Apollo is ERC20Detailed, Ownable {
    ...
    string public _name = "Apollo";
    string public _symbol = "Apollo";
    ...
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(ApolloInsuranceFundFee).add(
            firePitFee
        );
    ...
    constructor() ERC20Detailed("Apollo", "Apollo", uint8(DECIMALS)) Ownable() {
        ...
        ApolloInsuranceFundReceiver = 0x082D0FbCA3D80b2d4A05E20bFc227523bE8EFEF3;
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(ApolloInsuranceFundFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(ApolloInsuranceFundReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(ApolloInsuranceFundFee).div(
                treasuryFee.add(ApolloInsuranceFundFee)
            ),
            gas: 30000
        }("");
